...
This document covers the **v2.4.0 OpenClaude Terminal Production** workflow: launch the bundled app, build it quietly from source, create safe review-only imaging plans from Astro context, and attempt to open generated Advanced Sequencer plans for user review.
