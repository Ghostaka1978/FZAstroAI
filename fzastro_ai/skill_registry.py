...
SKILLS: tuple[Skill, ...] = (
    ...
    Skill(
        skill_id="astro",
        label="Astro",
        description="FZASTRO observing site, imaging, lookup, SUN NOW, SPACE LIVE, FZASTRO LIVE, distance-ladder, 7Timer seeing, targets, and native solar map tools.",
        icon="☉",
        actions=(
            _direct(
                "astro.site",
            ...
            _direct(
                "astro.space_live",
                "SPACE LIVE",
                "Live space and Earth streams with ISS, Sen SpaceTV-1, NASA/ESA events, NOAA GOES, and link fallbacks.",
            ...
            _composer(
                ...
                "OPEN PLANS FOLDER",
                "Open generated FZAstro Imaging/N.I.N.A. review plans.",
                section="FZASTRO IMAGING",
            ),
            _direct(
                "astro.nina_control",
                "FZASTRO IMAGING CONTROL",
                "Open launcher, update, and planning controls for the bundled imaging app.",
                "open_nina_control",
                section="FZASTRO IMAGING",
                favorite=True,
            ),
    ...
    Skill(
        skill_id="markets",
        label="Markets",
        description="Global market indicators, stocks, commodities, gold, and crude-oil pulse.",
        icon="$",
        actions=(
            _direct(
                "markets.global_pulse",
                "GLOBAL MARKET PULSE",
                "Summarize major global indices, volatility, rates, FX, oil, gold, CRM, and DBX.",
